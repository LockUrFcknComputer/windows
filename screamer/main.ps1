...
$image =  "https://github.com/LockUrFcknComputer/windows/blob/main/screamer/assets/imgs/woman-screaming.png?raw=true"
...
$wav = "https://github.com/LockUrFcknComputer/windows/blob/main/screamer/assets/sounds/scream.wav?raw=true"
